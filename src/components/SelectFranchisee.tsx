...
export interface PSelectFranchisee {
    selected_franchisee: string[]
    franchisees: string[]
    setInputField: any
    inputField: any
}

const SelectFranchisee = ({
    selected_franchisee,
    franchisees,
    setInputField,
    inputField,
}: PSelectFranchisee) => {
    const [leftSide, setLeftSide] = useState(franchisees)
    const [rightSide, setRightSide] = useState(selected_franchisee)
    const [selected, setSelected] = useState([])
    const [leftFilter, setLeftFilter] = useState('')
    const [rightFilter, setRightFilter] = useState('')
    const [filteredLeft, setFilteredLeft] = useState(franchisees)
    const [filteredRight, setFilteredRight] = useState(selected_franchisee)

    useEffect(() => {
        setInputField({ ...inputField, franchisees: rightSide })

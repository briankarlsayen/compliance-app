    ...
    <>
      {checkLists && (
        <TableContainer component={Paper} style={{ marginTop: "2rem" }}>
          <ChecklistFilter checklist={checklist} processRows={processRows} />
          <Table data-testid="checklist-table" role="table" size="small">
            ...
            <TableBody>
              ...
              >
                ...
                {!featureFlags?.hideCreateChecklistTemplate && activeBtn && (
                  <MenuItem onClick={handleClose}>{i18n.t("delete")}</MenuItem>
                )}
                {!featureFlags?.hideCreateChecklistTemplate && (
                  <MenuItem onClick={handleClose}>
                    {activeBtn ? i18n.t("deactivate") : i18n.t("activate")}
                  </MenuItem>
                )}
                {!featureFlags?.hideCreateChecklistTemplate && (
                  <MenuItem onClick={handleClose}>
                ...
                checkLists
                  ...
                  .map((row, index) => (
                    <StyledTableRow key={index} role="row">
                      <StyledTableCell role="cell">{row.name}</StyledTableCell>
